...
RSpec.describe Potepan::ProductDecorator, type: :model do
  ...
  let(:duplicate_related_products){ create(:product, taxons: [taxon2, taxon3]) }
  ...
  it "複数のカテゴリーに属する商品が関連商品に含まれないこと" do
    expect(product.related_products).not_to include duplicate_related_products
  end
end
